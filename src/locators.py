...
class AdminDashboardPageLocators(object):
    ...
    CATALOG = (By.XPATH, "//ul[@id='menu-catalog']")
    CATALOG_PRODUCTS = (By.XPATH, "//ul[@id='menu-catalog']//a[text()='Products']")
    CUSTOMERS = (By.XPATH, "//ul[@id='menu-customers']")
    CUSTOMERS_SECTION = (By.XPATH, "//ul[@id='menu-customers']//a[text()='Customers']")
...
class AdminAddProductPageLocators(object):
    ...
    METATAGDESCR_INPUT = (By.XPATH, "//input[@id='input-meta-description1']")
    METATAGKEYWRD = (By.XPATH, "//label[@for='input-meta-keyword1']")
    METATAGKEYWRD_INPUT = (By.XPATH, "//input[@id='input-meta-keyword1']")
    PRODUCTTAGS = (By.XPATH, "//label[@for='input-tag1']")
